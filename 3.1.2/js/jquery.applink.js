;(function ($, window, document, undefined) {
    ...
    var PopUp = function (s) {
        ...
        popupOpened.document.write('<html><head><title>Polychroma TV</title><meta name="viewport" content="width=device-width, initial-scale=1"><style>html{background:#000000;}body{background:url(../img/splash.540.gif) center no-repeat #000000; background-size: cover; margin: 0;}</style></head><body></body></html>');
        popupOpened.focus();
